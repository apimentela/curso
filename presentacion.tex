...
\note{
El sexo de una persona, así como su estado civil son ejemplos de variables del tipo nominal.
}
...
\note{
Un ejemplo de este tipo de variables es el coeficiente de inteligencia de una persona, se mide en valores como 60, 61, 62, etc. Pero no tiene sentido decir que una persona tiene 0 de coeficiente o que una con 60 es el doble de inteligente que una con 30.
}
...
\note{
Un ejemplo de este tipo de escalas la podemos ver en la altura de una persona, tiene sentido decir que una persona es el doble de alto que otra.
}
...
\frame{
\frametitle{Tabulación}
\begin{block}{}
	Por lo general, el análisis estadístico de datos inicia con un gran volumen de información en bruto. El primer paso para el análisis de datos es organizarlo esa información.
\end{block}
Veamos por ejemplo nuestra tabla de autores, en la tabla de idiomas podemos notar que tenemos: Francés, Francés, Inglés, Español, Francés, Inglés, Ingles, Inglés, Inglés, Ruso, Español, Francés, Alemán, Inglés, Francés, Ruso, Inglés, Francés, Español, Inglés, Inglés, Español, Español, Alemán y Francés.
}
...
\begin{tabular}{lr}
\toprule
	\textbf{Idioma} & \textbf{Frecuencia}\\ \midrule
	Francés & 7\\
	Inglés & 9\\
	Español & 5\\
	Alemán & 2\\
...
\begin{columns}
	\column{0.5\textwidth}
	\begin{block}{}
	Por otro lado, cuando se trata de información más fina, la tabulación puede no ayudarnos a resumir la información con la que se cuenta.
	\end{block}
	\column{0.5\textwidth}
	\begin{center}
\tiny
\begin{tabular}{lr}
\toprule
	\textbf{Edad} & \textbf{Frecuencia}\\ \midrule
      30 & 1 \\
      36 & 1 \\
      38 & 1 \\
      39 & 1 \\
...
\begin{columns}
	\column{0.5\textwidth}
	\begin{block}{}
	Cuando esto ocurre, es común optar por representar la información en categorías separadas por intervalos de datos.
	\end{block}
	\column{0.5\textwidth}
	\begin{center}
\begin{tabular}{lr}
\toprule
	\textbf{Edades} & \textbf{Frecuencia}\\ \midrule
      30 - 39 & 4 \\
      40 - 49 & 6 \\
      50 - 59 & 2 \\
      60 - 69 & 3 \\
